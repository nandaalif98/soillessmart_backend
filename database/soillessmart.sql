...
(0, 'awe@example.com', '$2a$10$kv3bRDv3sa2gu2GyOVTLRetttniNNZgAv5WEJGJhp2F/7HAubTuWW');
...
--
ALTER TABLE `posts`
  ADD CONSTRAINT `posts_ibfk_1` FOREIGN KEY (`community_id`) REFERENCES `communities` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
